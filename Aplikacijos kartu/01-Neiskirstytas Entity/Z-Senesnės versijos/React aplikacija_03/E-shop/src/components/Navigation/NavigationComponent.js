                ...
                <nav className="navbar navbar-expand-lg navbar-light bg-light">
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <UserContext.Consumer>
                            {
                                (userNameObject) => {
                                    return <Link className="btn btn-success" to="/shoppingCart" params={{name: userNameObject.user}}>Shopping cart</Link>
                                    //<AddToCartComponent userName={userNameObject.user} handleAddToCart={this.handleAddToCart} />
                                }
                            }
                        </UserContext.Consumer>
