...
import it.akademija.products.Clothes;
...
public class CartService {
	...
	public void addProductToCart(Cart cart, long productId, String productTitle, int quantity) {
		...
		currentCart.addProduct(new Clothes(productId, productTitle, quantity));
	...
	public void deleteProductFromCart(String user, long id) {
		Cart currentCart = new Cart();
		if(cartRepository.findCartByUsername(user) == null) {
			currentCart.setUsername(user);
		} else {
