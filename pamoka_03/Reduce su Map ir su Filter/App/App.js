...
//----------------- REDUCE su MAP ir su FILTER--------------------
//1.
var studentai = people
...
//1. Nauja kintamaji prilyginu funkcijai. paimu masyva ir su juo kvieciu metodus Filter, paskui Map, o paskui ir Reduce.
//Is pradziu atfiltuoju tuos objektus, kur laukas 'team' yra lygus "Studentai".
//Tada su MAP is tu atfiltruotu objektu paimu lauka 'name'.
//Ir toliau i sumini lauka 'vardai' sudedu visus 


//O ar parasyciau daba sia funkcija, kad dar ir default reiksme prie REDUCE butu?
//1.
var studentai = people
                .filter(pupil => pupil.team === 'Studentai')
                .map(pupil => pupil.name)
