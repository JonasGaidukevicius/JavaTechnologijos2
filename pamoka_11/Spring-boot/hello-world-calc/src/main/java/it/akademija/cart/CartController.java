...
public class CartController {
	...
	public Cart getCart(@ApiParam(value = "User", required = true) @Valid @PathVariable final String user) {
	...
	public void addProductToCart(@ApiParam(value = "User", required = true) @Valid @PathVariable final String user,
		...
		cartService.addProductToCart(new Cart(user), cmd.getProductId(), cmd.getProductTitle(), cmd.getQuantity());
